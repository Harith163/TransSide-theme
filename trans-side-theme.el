...
(custom-theme-set-faces
 ...
 '(mode-line ((((class color) (min-colors 89)) (:box (:line-width 1 :color nil) :bold t :foreground "#1b85bd" :background "#141414"))))
 '(mode-line-inactive ((((class color) (min-colors 89)) (:box (:line-width 1 :color nil :style pressed-button) :foreground "#1b85bd" :background "#272727" :weight normal))))
 '(mode-line-buffer-id ((((class color) (min-colors 89)) (:bold t :foreground "#1b85bd" :background nil))))
